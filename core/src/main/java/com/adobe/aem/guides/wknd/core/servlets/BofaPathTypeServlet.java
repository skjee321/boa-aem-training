...
@SlingServletPaths(
        value = {"/bin/pages","/wknd/pages"}
)
// "/wknd/pages" -- custom path to be allowed on OSGi Config - Sling Servlet / Script Resolver and Error Handler
public class BofaPathTypeServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(BofaPathTypeServlet.class);
