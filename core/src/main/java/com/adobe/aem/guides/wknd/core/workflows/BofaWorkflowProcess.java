...
@Component(
        ...
        immediate = true,
        property = {
                "process.label" + " = Bofa Training Workflow Process",
                Constants.SERVICE_VENDOR + "=Bofa Training",
                Constants.SERVICE_DESCRIPTION + " = Custom Bofa Training workflow step."
        }
)
public class BofaWorkflowProcess implements WorkflowProcess {

    private static final Logger log = LoggerFactory.getLogger(BofaWorkflowProcess.class);
