...
public class BofaResourceTypesServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(BofaResourceTypesServlet.class);
